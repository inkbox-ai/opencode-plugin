...
| `API key is not agent-scoped` | Outbound may work, but channel, note, and vault reads can behave differently. Prefer an agent-scoped key bound to the configured identity. |
